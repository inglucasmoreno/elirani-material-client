...
export class AuthService {
  ...
  validarToken(): Observable<any> {
    ...
    return this.http.get(`${base_url}/profile`, {
      ...
      map((resp: any) => {
        const { userId, usuario, dni, email, apellido, nombre, role, permisos } = resp.usuario;
        this.usuario = new UsuarioOnline(userId, usuario, dni, email, nombre, apellido, role, permisos);
